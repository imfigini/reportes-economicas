------------------------------------------------------------
--[17]--  Listado de nuevos inscriptos 
------------------------------------------------------------
...
INSERT INTO apex_molde_operacion (proyecto, molde, operacion_tipo, nombre, item, carpeta_archivos, prefijo_clases, fuente, punto_montaje) VALUES (
	...
	'17', --molde
	'10', --operacion_tipo
	'Listado de nuevos inscriptos', --nombre
	'3480', --item
	'listado_de_nuevos_inscriptos', --carpeta_archivos
	'_listado_de_nuevos_inscriptos', --prefijo_clases
	'Reportes', --fuente
	'14'  --punto_montaje
);
