...
INSERT INTO apex_objeto_ci_pantalla (objeto_ci_proyecto, objeto_ci, pantalla, identificador, orden, etiqueta, descripcion, tip, imagen_recurso_origen, imagen, objetos, eventos, subclase, subclase_archivo, template, template_impresion, punto_montaje) VALUES (
	...
	'1', --orden
	'Pantalla', --etiqueta
	'Detalle de los alumnos de Ingeniería de Sistemas y sus finales (sólo de las materias del departamento de Sistemas). Alumno, año de ingreso, materia, a qué año de cursada corresponde la materia, si la aprobó o no y en qué fecha, y de qué manera (examen, promoción o equivalencia).', --descripcion
	NULL, --tip
