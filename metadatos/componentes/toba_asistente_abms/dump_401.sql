------------------------------------------------------------
--[401]--  Reporte de Cambio de carrera 
------------------------------------------------------------
...
INSERT INTO apex_molde_operacion (proyecto, molde, operacion_tipo, nombre, item, carpeta_archivos, prefijo_clases, fuente, punto_montaje) VALUES (
	...
	'401', --molde
	'10', --operacion_tipo
	'Reporte de Cambio de carrera', --nombre
	'4019', --item
	'reporte_de_cambio_de_carrera', --carpeta_archivos
	'_reporte_de_cambio_de_carrera', --prefijo_clases
	'Reportes', --fuente
	'14'  --punto_montaje
);
