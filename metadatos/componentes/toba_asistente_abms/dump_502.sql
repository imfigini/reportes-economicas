------------------------------------------------------------
--[502]--  alumnos_cursadas_tit_intermedio 
------------------------------------------------------------
...
INSERT INTO apex_molde_operacion (proyecto, molde, operacion_tipo, nombre, item, carpeta_archivos, prefijo_clases, fuente, punto_montaje) VALUES (
	...
	'502', --molde
	'10', --operacion_tipo
	'alumnos_cursadas_tit_intermedio', --nombre
	'4175', --item
	'alumnos_cursadas_tit_interm', --carpeta_archivos
	'_alumnos_cursadas_tit_interm', --prefijo_clases
	'Reportes', --fuente
	'14'  --punto_montaje
);
