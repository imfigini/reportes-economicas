------------------------------------------------------------
--[21]--  Lista de Mails de Postgrado 
------------------------------------------------------------
...
INSERT INTO apex_molde_operacion (proyecto, molde, operacion_tipo, nombre, item, carpeta_archivos, prefijo_clases, fuente, punto_montaje) VALUES (
	...
	'21', --molde
	'10', --operacion_tipo
	'Lista de Mails de Postgrado', --nombre
	'3485', --item
	'lista_de_mails_de_postgrado', --carpeta_archivos
	'_lista_de_mails_de_postgrado', --prefijo_clases
	'Reportes', --fuente
	'14'  --punto_montaje
);
