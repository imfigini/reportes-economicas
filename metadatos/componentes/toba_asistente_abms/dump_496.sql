------------------------------------------------------------
--[496]--  datos_censales_trab_internet 
------------------------------------------------------------
...
INSERT INTO apex_molde_operacion (proyecto, molde, operacion_tipo, nombre, item, carpeta_archivos, prefijo_clases, fuente, punto_montaje) VALUES (
	...
	'496', --molde
	'10', --operacion_tipo
	'datos_censales_trab_internet', --nombre
	'4169', --item
	'datos_censales_trab_internet', --carpeta_archivos
	'_datos_censales_trab_internet', --prefijo_clases
	'Reportes', --fuente
	'14'  --punto_montaje
);
