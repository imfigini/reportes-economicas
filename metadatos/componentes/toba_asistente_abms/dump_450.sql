------------------------------------------------------------
--[450]--  Informe inscrip x instancia 
------------------------------------------------------------
...
INSERT INTO apex_molde_operacion (proyecto, molde, operacion_tipo, nombre, item, carpeta_archivos, prefijo_clases, fuente, punto_montaje) VALUES (
	...
	'450', --molde
	'10', --operacion_tipo
	'Informe inscrip x instancia', --nombre
	'4103', --item
	'informe_inscrip_x_instancia', --carpeta_archivos
	'_informe_inscrip_x_instancia', --prefijo_clases
	'Reportes', --fuente
	'14'  --punto_montaje
);
