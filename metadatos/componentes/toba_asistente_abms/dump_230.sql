------------------------------------------------------------
--[230]--  Alumnos que cumplen los requisitos 
------------------------------------------------------------
...
INSERT INTO apex_molde_operacion (proyecto, molde, operacion_tipo, nombre, item, carpeta_archivos, prefijo_clases, fuente, punto_montaje) VALUES (
	...
	'230', --molde
	'10', --operacion_tipo
	'Alumnos que cumplen los requisitos', --nombre
	'3775', --item
	'alumnos_con_requisitos_pps', --carpeta_archivos
	'_alumnos_con_requisitos_pps', --prefijo_clases
	'Reportes', --fuente
	'14'  --punto_montaje
);
