------------------------------------------------------------
--[364]--  Alumnos cohorte reinscriptos 
------------------------------------------------------------
...
INSERT INTO apex_molde_operacion (proyecto, molde, operacion_tipo, nombre, item, carpeta_archivos, prefijo_clases, fuente, punto_montaje) VALUES (
	...
	'364', --molde
	'10', --operacion_tipo
	'Alumnos cohorte reinscriptos', --nombre
	'3971', --item
	'alumnos_cohorte_reinscriptos', --carpeta_archivos
	'_alumnos_cohorte_reinscriptos', --prefijo_clases
	'Reportes', --fuente
	'14'  --punto_montaje
);
