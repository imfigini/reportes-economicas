------------------------------------------------------------
--[404]--  desaprobados curso de ingreso 
------------------------------------------------------------
...
INSERT INTO apex_molde_operacion (proyecto, molde, operacion_tipo, nombre, item, carpeta_archivos, prefijo_clases, fuente, punto_montaje) VALUES (
	...
	'404', --molde
	'10', --operacion_tipo
	'desaprobados curso de ingreso', --nombre
	'4022', --item
	'desaprobados_curso_de_ingreso', --carpeta_archivos
	'_desaprobados_curso_de_ingreso', --prefijo_clases
	'Reportes', --fuente
	'14'  --punto_montaje
);
