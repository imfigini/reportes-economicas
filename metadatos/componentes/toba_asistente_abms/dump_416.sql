------------------------------------------------------------
--[416]--  alumnos activos y egresados 
------------------------------------------------------------
...
INSERT INTO apex_molde_operacion (proyecto, molde, operacion_tipo, nombre, item, carpeta_archivos, prefijo_clases, fuente, punto_montaje) VALUES (
	...
	'416', --molde
	'10', --operacion_tipo
	'alumnos activos y egresados', --nombre
	'4050', --item
	'alumnos_activos_y_egresados', --carpeta_archivos
	'_alumnos_activos_y_egresados', --prefijo_clases
	'Reportes', --fuente
	'14'  --punto_montaje
);
