------------------------------------------------------------
--[402]--  Alumnos por comision Moodle 
------------------------------------------------------------
...
INSERT INTO apex_molde_operacion (proyecto, molde, operacion_tipo, nombre, item, carpeta_archivos, prefijo_clases, fuente, punto_montaje) VALUES (
	...
	'402', --molde
	'10', --operacion_tipo
	'Alumnos por comision Moodle', --nombre
	'4020', --item
	'alumnos_por_comision_moodle', --carpeta_archivos
	'_alumnos_por_comision_moodle', --prefijo_clases
	'Reportes', --fuente
	'14'  --punto_montaje
);
