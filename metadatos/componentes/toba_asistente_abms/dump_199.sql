------------------------------------------------------------
--[199]--  Alumnos próximos a recibirse 
------------------------------------------------------------
...
INSERT INTO apex_molde_operacion (proyecto, molde, operacion_tipo, nombre, item, carpeta_archivos, prefijo_clases, fuente, punto_montaje) VALUES (
	...
	'199', --molde
	'10', --operacion_tipo
	'Alumnos próximos a recibirse', --nombre
	'3732', --item
	'alumnos_proximos_a_recibirse', --carpeta_archivos
	'_alumnos_proximos_a_recibirse', --prefijo_clases
	'Reportes', --fuente
	'14'  --punto_montaje
);
