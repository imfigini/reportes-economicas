------------------------------------------------------------
--[419]--  cantidad_aprob_desap_materia 
------------------------------------------------------------
...
INSERT INTO apex_molde_operacion (proyecto, molde, operacion_tipo, nombre, item, carpeta_archivos, prefijo_clases, fuente, punto_montaje) VALUES (
	...
	'419', --molde
	'10', --operacion_tipo
	'cantidad_aprob_desap_materia', --nombre
	'4054', --item
	'cantidad_aprob_desap_materia', --carpeta_archivos
	'_cantidad_aprob_desap_materia', --prefijo_clases
	'Reportes', --fuente
	'14'  --punto_montaje
);
