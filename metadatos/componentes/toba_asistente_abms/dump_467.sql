------------------------------------------------------------
--[467]--  listado_docentes_responsables 
------------------------------------------------------------
...
INSERT INTO apex_molde_operacion (proyecto, molde, operacion_tipo, nombre, item, carpeta_archivos, prefijo_clases, fuente, punto_montaje) VALUES (
	...
	'467', --molde
	'10', --operacion_tipo
	'listado_docentes_responsables', --nombre
	'4124', --item
	'listado_docentes_responsables', --carpeta_archivos
	'_listado_docentes_responsables', --prefijo_clases
	'Reportes', --fuente
	'14'  --punto_montaje
);
