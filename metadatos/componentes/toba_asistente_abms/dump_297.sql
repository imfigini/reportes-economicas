------------------------------------------------------------
--[297]--  ext_x_anio_ingreso_y_avance 
------------------------------------------------------------
...
INSERT INTO apex_molde_operacion (proyecto, molde, operacion_tipo, nombre, item, carpeta_archivos, prefijo_clases, fuente, punto_montaje) VALUES (
	...
	'297', --molde
	'10', --operacion_tipo
	'ext_x_anio_ingreso_y_avance', --nombre
	'3875', --item
	'ext_x_anio_ingreso_y_avance', --carpeta_archivos
	'_ext_x_anio_ingreso_y_avance', --prefijo_clases
	'Reportes', --fuente
	'14'  --punto_montaje
);
