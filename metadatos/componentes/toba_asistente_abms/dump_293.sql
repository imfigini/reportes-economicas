------------------------------------------------------------
--[293]--  ext_seguimiento_extensiones 
------------------------------------------------------------
...
INSERT INTO apex_molde_operacion (proyecto, molde, operacion_tipo, nombre, item, carpeta_archivos, prefijo_clases, fuente, punto_montaje) VALUES (
	...
	'293', --molde
	'10', --operacion_tipo
	'ext_seguimiento_extensiones', --nombre
	'3869', --item
	'ext_seguimiento_extensiones', --carpeta_archivos
	'_ext_seguimiento_extensiones', --prefijo_clases
	'Reportes', --fuente
	'14'  --punto_montaje
);
