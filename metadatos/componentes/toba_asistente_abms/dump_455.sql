------------------------------------------------------------
--[455]--  Listado exceptuados al curso de ingreso 
------------------------------------------------------------
...
INSERT INTO apex_molde_operacion (proyecto, molde, operacion_tipo, nombre, item, carpeta_archivos, prefijo_clases, fuente, punto_montaje) VALUES (
	...
	'455', --molde
	'10', --operacion_tipo
	'Listado exceptuados al curso de ingreso', --nombre
	'4109', --item
	'listado_exceptuados_al_curso_de_ingreso', --carpeta_archivos
	'_listado_exceptuados_cur_ingr', --prefijo_clases
	'Reportes', --fuente
	'14'  --punto_montaje
);
