------------------------------------------------------------
--[190]--  Alumnos con correlativas aprobadas 
------------------------------------------------------------
...
INSERT INTO apex_molde_operacion (proyecto, molde, operacion_tipo, nombre, item, carpeta_archivos, prefijo_clases, fuente, punto_montaje) VALUES (
	...
	'190', --molde
	'10', --operacion_tipo
	'Alumnos con correlativas aprobadas', --nombre
	'3720', --item
	'alumnos_con_correlat_aprob', --carpeta_archivos
	'_alumnos_con_correlat_aprob', --prefijo_clases
	'Reportes', --fuente
	'14'  --punto_montaje
);
