------------------------------------------------------------
--[229]--  Alumnos que NO cumplen los requisitos 
------------------------------------------------------------
...
INSERT INTO apex_molde_operacion (proyecto, molde, operacion_tipo, nombre, item, carpeta_archivos, prefijo_clases, fuente, punto_montaje) VALUES (
	...
	'229', --molde
	'10', --operacion_tipo
	'Alumnos que NO cumplen los requisitos', --nombre
	'3774', --item
	'alumnos_sin_requisitos_pps', --carpeta_archivos
	'_alumnos_sin_requisitos_pps', --prefijo_clases
	'Reportes', --fuente
	'14'  --punto_montaje
);
