------------------------------------------------------------
--[449]--  desaprob_curso_ingreso_2018 
------------------------------------------------------------
...
INSERT INTO apex_molde_operacion (proyecto, molde, operacion_tipo, nombre, item, carpeta_archivos, prefijo_clases, fuente, punto_montaje) VALUES (
	...
	'449', --molde
	'10', --operacion_tipo
	'desaprob_curso_ingreso_2018', --nombre
	'4100', --item
	'desaprob_curso_ingreso_2018', --carpeta_archivos
	'_desaprob_curso_ingreso_2018', --prefijo_clases
	'Reportes', --fuente
	'14'  --punto_montaje
);
