------------------------------------------------------------
--[459]--  Inscriptos a cursar ingreso 
------------------------------------------------------------
...
INSERT INTO apex_molde_operacion (proyecto, molde, operacion_tipo, nombre, item, carpeta_archivos, prefijo_clases, fuente, punto_montaje) VALUES (
	...
	'459', --molde
	'10', --operacion_tipo
	'Inscriptos a cursar ingreso', --nombre
	'4114', --item
	'inscriptos_a_cursar_ingreso', --carpeta_archivos
	'_inscriptos_a_cursar_ingreso', --prefijo_clases
	'Reportes', --fuente
	'14'  --punto_montaje
);
